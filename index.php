...
class homepage extends page {
    ...
    public function get() {
        ...
        echo '<title>Upload the file here</title></head>';
        ...
        echo '<p><strong>Note:</strong> Only .jpg, .jpeg, .gif, .png formats allowed to a max size of 5 MB.</p>';
        echo '</form></body></html>';
    }
              ...
              if(isset($_FILES["photo"]) && $_FILES["photo"]["error"] == 0){
                  ...
                  $maxsize = 5 * 1024 * 1024;
                    ...
                    if(file_exists("upload/" . $_FILES["photo"]["name"])){
                      ...
                      header("Location:https://web.njit.edu/~aps86/Project1234/index.php?page=htmlTable&name=$filename");
            }
